                                           ...
                                           ?>                                      
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center" style="width:28%">
                                                    <a href="../view-content.php?contentid=<?php echo htmlentities($result->id);?>" target="_blank"><button class="btn btn-primary"><i class="fa fa-eye "></i> View</button>
                                                    <a href="edit-content.php?contentid=<?php echo htmlentities($result->id);?>"><button class="btn btn-success"><i class="fa fa-edit "></i> Edit</button> 
                                                      <a href="manage-contents.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                                      </td>
                                                  </tr>
                                                  <?php $cnt=$cnt+1;}} ?>                                      
                                              </tbody>
